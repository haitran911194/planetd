...
export class Api extends HttpClient {
    constructor() {
         ...
         * @request GET:/cosmonaut/planet/blog/params
         */
        this.queryParams = (params = {}) => this.request({
            path: `/cosmonaut/planet/blog/params`,
            method: "GET",
            format: "json",
            ...params,
        });
         ...
         * @request GET:/cosmonaut/planet/blog/post
         */
        this.queryPostAll = (query, params = {}) => this.request({
            path: `/cosmonaut/planet/blog/post`,
            method: "GET",
            query: query,
            format: "json",
            ...params,
         ...
         * @request GET:/cosmonaut/planet/blog/post/{id}
         */
         ...
         * @request GET:/cosmonaut/planet/blog/sent_post
         */
        this.querySentPostAll = (query, params = {}) => this.request({
            path: `/cosmonaut/planet/blog/sent_post`,
            method: "GET",
            query: query,
            format: "json",
            ...params,
         ...
         * @request GET:/cosmonaut/planet/blog/sent_post/{id}
         */
        this.querySentPost = (id, params = {}) => this.request({
            path: `/cosmonaut/planet/blog/sent_post/${id}`,
            method: "GET",
            format: "json",
            ...params,
        });
         ...
         * @request GET:/cosmonaut/planet/blog/timedout_post
         */
        this.queryTimedoutPostAll = (query, params = {}) => this.request({
            path: `/cosmonaut/planet/blog/timedout_post`,
            method: "GET",
            query: query,
            format: "json",
            ...params,
         ...
         * @request GET:/cosmonaut/planet/blog/timedout_post/{id}
         */
        this.queryTimedoutPost = (id, params = {}) => this.request({
            path: `/cosmonaut/planet/blog/timedout_post/${id}`,
            method: "GET",
            format: "json",
            ...params,
        });
