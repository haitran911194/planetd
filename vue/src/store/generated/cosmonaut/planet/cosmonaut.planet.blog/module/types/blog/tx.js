...
export const protobufPackage = "cosmonaut.planet.blog";
...
export class MsgClientImpl {
    ...
    CreateSentPost(request) {
        ...
        const promise = this.rpc.request("cosmonaut.planet.blog.Msg", "CreateSentPost", data);
    ...
    UpdateSentPost(request) {
        ...
        const promise = this.rpc.request("cosmonaut.planet.blog.Msg", "UpdateSentPost", data);
    ...
    DeleteSentPost(request) {
        ...
        const promise = this.rpc.request("cosmonaut.planet.blog.Msg", "DeleteSentPost", data);
    ...
    CreateTimedoutPost(request) {
        ...
        const promise = this.rpc.request("cosmonaut.planet.blog.Msg", "CreateTimedoutPost", data);
    ...
    UpdateTimedoutPost(request) {
        ...
        const promise = this.rpc.request("cosmonaut.planet.blog.Msg", "UpdateTimedoutPost", data);
    ...
    DeleteTimedoutPost(request) {
        ...
        const promise = this.rpc.request("cosmonaut.planet.blog.Msg", "DeleteTimedoutPost", data);
