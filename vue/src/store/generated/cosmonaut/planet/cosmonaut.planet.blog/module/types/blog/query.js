...
const baseQueryGetTimedoutPostRequest = { id: 0 };
...
const baseQueryAllTimedoutPostRequest = {};
...
const baseQueryAllTimedoutPostResponse = {};
...
export class QueryClientImpl {
    ...
    Params(request) {
        ...
        const promise = this.rpc.request("cosmonaut.planet.blog.Query", "Params", data);
        return promise.then((data) => QueryParamsResponse.decode(new Reader(data)));
    }
    Post(request) {
        const data = QueryGetPostRequest.encode(request).finish();
        const promise = this.rpc.request("cosmonaut.planet.blog.Query", "Post", data);
        return promise.then((data) => QueryGetPostResponse.decode(new Reader(data)));
    }
    PostAll(request) {
        const data = QueryAllPostRequest.encode(request).finish();
        const promise = this.rpc.request("cosmonaut.planet.blog.Query", "PostAll", data);
    ...
    SentPost(request) {
        ...
        const promise = this.rpc.request("cosmonaut.planet.blog.Query", "SentPost", data);
    ...
    SentPostAll(request) {
        ...
        const promise = this.rpc.request("cosmonaut.planet.blog.Query", "SentPostAll", data);
    ...
    TimedoutPost(request) {
        ...
        const promise = this.rpc.request("cosmonaut.planet.blog.Query", "TimedoutPost", data);
        return promise.then((data) => QueryGetTimedoutPostResponse.decode(new Reader(data)));
    }
    TimedoutPostAll(request) {
        const data = QueryAllTimedoutPostRequest.encode(request).finish();
        const promise = this.rpc.request("cosmonaut.planet.blog.Query", "TimedoutPostAll", data);
